...
## Instalação
Para instalar os arquivos, baixe o zip [qlik_saas_utils.zip](qlik_saas_utils.zip) e descompacte-o em um diretório. Se necessário, coloque o na PATH do seu ambiente. Em seguida basta executar qualquer script pela linha de comando.
...
Para saber se ele está instalado em seu sistema, basta entrar no cmd (ou terminal) e executar o comando *curl* .
    ...
    pbergo@desktop-pbergo:~$ curl --version
